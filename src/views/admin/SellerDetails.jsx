      ...
      <div className='w-full p-4 bg-[#6a5fdf] rounded-md'>
        ...
        <div className='w-full flex flex-wrap text-[#d0d2d6]'>
            <div className='w-3/12 flex justify-center items-center py-3'>
                <div>
                   {
                    seller?.image ?  <img className='w-full h-[230px]' src={seller?.image||"http://localhost:3000/images/demo.jpg"} alt="" /> :
        ...
        <div> 
            <form onSubmit={submit}>
                <div className='flex gap-4 py-3'>
                    <select onChange={(e)=>setstatus(e.target.value)} value={status} className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]' name="" id="">
